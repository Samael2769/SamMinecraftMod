...
public class SamArmor extends ArmorItem implements IDamageHandlingArmor {
    public SamArmor(ArmorMaterial material, EquipmentSlot slot, Properties properties) {
    ...
    public float onDamaged(LivingEntity entity, EquipmentSlot slot, DamageSource source, float amount) {
        ...
        if (attacker instanceof LivingEntity){
            attacker.hurt(DamageSource.DRAGON_BREATH, amount / 2);
