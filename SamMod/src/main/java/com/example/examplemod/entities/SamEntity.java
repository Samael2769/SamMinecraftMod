...
public class SamEntity extends Animal {
    public SamEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        return EntityInit.SAM_ENTITY.get().create(level);
    }
    ...
    public static boolean canSpawn(EntityType<SamEntity> entityType, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
