...
public class SamEnemiEntityModel extends EntityModel<SamEnemiEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ExampleMod.MODID, "sam_entity"), "main");

    private final ModelPart body;

    public SamEnemiEntityModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SamEnemiEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
