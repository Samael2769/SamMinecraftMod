...
public class SamEntityModel extends EntityModel<SamEntity> {
    ...
    public SamEntityModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SamEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
